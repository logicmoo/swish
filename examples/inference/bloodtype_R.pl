...
?- prob(bloodtype(p,a),Prob),bar_r(Prob). % what is the probability that the p's bloodtype is a?
% expected result 0.1957737927437685
?- prob(bloodtype(p,b),Prob),bar_r(Prob). % what is the probability that the p's bloodtype is b?
% expected result 0.22385005085999995
?- prob(bloodtype(p,ab),Prob),bar_r(Prob). % what is the probability that the p's bloodtype is ab?
% expected result 0.193292577
?- prob(bloodtype(p,null),Prob),bar_r(Prob). % what is the probability that the p's bloodtype is 0?
%  expected result 0.1375200361199999
*/
