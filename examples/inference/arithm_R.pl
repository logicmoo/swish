...
% exected result
% V = [[4]-100].
?- mc_mh_sample_arg_bar_r(eval(2,Y),(eval(0,2),eval(1,3)),100,100,3,Y).
...
?- mc_mh_sample_arg_bar_r(eval(2,Y),eval(1,3),100,100,3,Y).
...
% exected result
% V = [[3]-79, [4]-8, [6]-8, [2]-5].
?- mc_rejection_sample_arg_bar_r(eval(2,Y),eval(1,3),100,Y).
...
?- mc_mh_expectation(eval(2,Y),eval(1,3),100,100,3,Y,E).
